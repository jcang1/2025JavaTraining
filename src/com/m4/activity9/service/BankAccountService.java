...
public class BankAccountService {
	...
	public void createAccount(String accountNumber, String ownerName, double initialBalance)
		...
		if (initialBalance < MINIMUM_INITIAL_BALANCE) {
			...
			String message = "MINIMUM_INITIAL_BALANCE " + String.format("%.2f", MINIMUM_INITIAL_BALANCE) +
					"\ninitialBalance " + String.format("%.2f", initialBalance);
		...
		if (accountExists(accountNumber)) {
			...
			String message = "Account number already exists: " + accountNumber;
			throw new InvalidAccountException(message);
		}
	...
	public void transfer(String fromAccountNumber, String toAccountNumber, double amount)
		...
		if (amount <= 0) {
			...
			String message = "Transfer amount must be positive. Received: " + String.format("%.2f", amount);
		...
		if (fromAccount.getBalance() < amount) {
			...
			logger.warn("Balance: {}, Required: {}");
			logger.warn(fromAccountNumber, fromAccount.getBalance(), amount);
			...
			throw new InsufficientFundsException(String.format("%.2f", fromAccount.getBalance()));
